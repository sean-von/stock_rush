...
public class StringUtil {
  ...
  public static String getReqPara(HttpServletRequest request,String para,String defreturn){
	  return StringUtil.isEmpty(request.getParameter(para))?defreturn:request.getParameter(para).trim();
  }
  
  public static String getReqPara(HttpServletRequest request,String para){
	  return StringUtil.isEmpty(request.getParameter(para))?"":request.getParameter(para).trim();
  }
  
  public static String renameFile(String filename){
		if (filename != null && filename.length() > 0) {
			Random rm = new Random();
			int mid = rm.nextInt(10000);
			String checkifgo = filename.substring(filename.lastIndexOf('.')).toLowerCase();
			String tmpFilename = timeFormat.format(new Date()) + mid + checkifgo;
			return tmpFilename;
		}else{
			return "error";
		}
	...
	public static boolean isNum(String str) {
	 ...
	 /**
	  ...
	  public static int  getRandomNum(int Max){
	    	...
	    	return (int) (Math.round(Rand * Range));
	  }
	  ...
	  public static String format(String src,Object... param){
		  List<Object> params = new ArrayList<Object>();
			...
			return String.format(src, params.toArray());
	  }
	   ...
	   * @return
	   */
	  public static String toLowerAndEscapeSpace(String string){
		  String bakString = "";
		  if(string!=null){
			  bakString = string.trim().replaceAll("\\s{1,}", "").toLowerCase();  
		  }
		  return bakString;
	  }
	  ...
	  /**
		 ...
		 * @throws Exception
		 */
	 public static String subStr(String s,int n,String encodeName,String postfix){
			try{
		        ...
		        return new String(resultBytes, 0, j, encodeName)+postfix; 
			}catch (Exception e) {
	 ...
	 /**
	  * 格式化autoid，将其格式化为num个的字符串，不足以0补齐
	  * @param autoid
	  * @param num
	  */
	 public static String formatAutoId(int autoid,int num){
		 String bakValue = "";
		 if(autoid<0 || num<=0){
			 return autoid+"";
		 }
		 int value = (int)Math.pow(10, num);
		 if(autoid<value){
			 autoid = value+autoid;
			 bakValue = (autoid+"").substring(1);
		 }else{
			 return autoid+"";
		 }
		 return bakValue;
	 ...
	 /**
	  * format yyyy/MM/dd HH:mm:ss 格式的时间字符串为 yyyy-MM-dd 格式
	  * @param date
	  * @return
	  */
...
//		System.out.println(o.toString());
		...
		System.out.println(StringUtil.toLowerAndEscapeSpace("Sony Erricssion"));
		
		System.out.println(formatAutoId(125478, 6));
	}
